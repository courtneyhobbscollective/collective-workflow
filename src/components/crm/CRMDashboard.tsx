  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">AI-powered client relationship management and communications</p>
      </div>
      ...
      <Tabs defaultValue="ai-analysis" className="space-y-6">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="follow-ups" className="flex items-center space-x-2">
